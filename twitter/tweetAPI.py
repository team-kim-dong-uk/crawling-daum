...
JSON 구조는 최하단 참고
"""
configFile = 'tweetKeys.ini'
parser = configparser.ConfigParser()
parser.read(os.getcwd() + '/' + configFile)

consumer_key = parser['keys']['consumer_key']
consumer_secret = parser['keys']['consumer_secret']
access_token = parser['keys']['access_token']
access_token_secret = parser['keys']['access_token_secret']
